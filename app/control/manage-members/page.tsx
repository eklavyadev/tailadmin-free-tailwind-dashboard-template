...
export const metadata: Metadata = {
  title: "Register Member | PetaWeb SuperAdmin",
  description: "Register Member | PetaWeb SuperAdmin",
  // other metadata
};
                ...
                <div className="mb-4.5">
                  ...
                  <div className="relative z-20 bg-transparent dark:bg-form-input">
                    <select className="relative z-20 w-full appearance-none rounded border border-stroke bg-transparent py-3 px-5 outline-none transition focus:border-primary active:border-primary dark:border-form-strokedark dark:bg-form-input dark:focus:border-primary">
                      ...
                      <option value="">Full Stack App Developer (Android/iOS)</option>
                      ...
                      <option value="">Cyber Security Engineer</option>
            ...
            <form action="#">
              <div className="p-6.5">
                ...
                <div className="mt-5 mb-5.5 flex items-center justify-between">
                  ...
                  <a href="#" className="text-sm text-meta-1">
                    View All Member Email ID
                  </a>
                </div>

                <button className="flex w-full justify-center rounded bg-meta-7 p-3 font-medium text-gray">
                  Restrict Member 
                </button>
              </div>
            </form>
            ...
            <form action="#">
              <div className="p-6.5">
                ...
                <div className="mb-5.5">
                  ...
                  <input
                    type="password"
                    placeholder="Re-enter Member ID"
                    className="w-full rounded border-[1.5px] border-stroke bg-transparent py-3 px-5 font-medium outline-none transition focus:border-primary active:border-primary disabled:cursor-default disabled:bg-whiter dark:border-form-strokedark dark:bg-form-input dark:focus:border-primary"
                  />
                </div>
