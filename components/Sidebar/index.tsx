          ...
          <div>
            ...
            <ul className="mb-6 flex flex-col gap-1.5">
              ...
              <li>
                <Link
                  href="/messages"
                  className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${pathname.includes("messages") && "bg-graydark dark:bg-meta-4"
                    }`}
                >
                  <svg
                    className="fill-current"
                  ...
                  <span className="absolute right-4 block rounded bg-primary py-1 px-2 text-xs font-medium text-white">9+</span>
                </Link>
              </li>
              {/* <! -- Menu Item Chat --> */}
              ...
              <SidebarLinkGroup
                activeCondition={
                  pathname === "/control" || pathname.includes("control")
                }
              >
                {(handleClick, open) => {
                  return (
                    <React.Fragment>
                      <Link
                        href="#"
                        className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${(pathname === "/control" ||
                        ...
                        <ul className="mt-4 mb-5.5 flex flex-col gap-2.5 pl-6">
                          <li>
                            <Link
                              ...
                              className={`first-letter:group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white ${pathname === "/control/permissions" &&
                                "text-white"
                                }`}
                            >
                              Permissions
                          ...
                          <li>
                            <Link
                              href="/control/manage-members"
                              className={`group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white ${pathname === "/control/manage-members" &&
                                "text-white"
                                }`}
                            >
                              Manage Members
              ...
              <li>
                <Link
                  href="/orders"
                  className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${pathname.includes("orders") &&
                    "bg-graydark dark:bg-meta-4"
                    }`}
                >
                  <svg
                  ...
                  Orders
                  <span className="absolute right-4 block rounded bg-primary py-1 px-2 text-xs font-medium text-white">Pro</span>
                </Link>
              </li>
